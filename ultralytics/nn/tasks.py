...
from ultralytics.nn.ADD import ADD
from ultralytics.nn.FFT import FourierBlock
from ultralytics.nn.MIXDFF import DFF
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolo11n.yaml", ch=9, nc=None, verbose=True):
        """
...
class SegmentationModel(DetectionModel):
    ...
    def __init__(self, cfg="yolo11n-seg.yaml", ch=9, nc=None, verbose=True):
        """
...
class ClassificationModel(BaseModel):
    ...
    def __init__(self, cfg="yolo11n-cls.yaml", ch=9, nc=None, verbose=True):
        """
